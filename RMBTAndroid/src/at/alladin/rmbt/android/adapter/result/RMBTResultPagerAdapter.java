...
public class RMBTResultPagerAdapter extends PagerAdapter {
	...
	static {
		...
		RESULT_PAGE_TAB_TITLE_MAP.put(RESULT_PAGE_MAP, 3);
	}
    ...
    public int getCount()
    {
    	return RESULT_PAGE_TAB_TITLE_MAP.size();//(RMBTResultPagerFragment.MAP_INDICATOR_DYNAMIC_VISIBILITY ? (hasMap ? 5 : 4) : 5);
    }
