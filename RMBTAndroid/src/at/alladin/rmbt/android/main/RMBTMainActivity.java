...
public class RMBTMainActivity extends FragmentActivity implements MapProperties
{
    ...
    /**
     * set the start-screen's view id
     */
    public final static int START_FRAGMENT_ID = R.layout.simple_title_screen;
    ...
    public void clearLastMeasurement() {
        ...
        if (f != null) {
            ((RMBTMainMenuFragment) f).toggleNerdModeVisibility(true);
        }
    }
    ...
    public void startTest(final boolean popStack)
    {
	    ...
	    startTestFromResultsScreen(popStack, Integer.MIN_VALUE, Integer.MIN_VALUE);
    }
     ...
     */
    public void startTestFromResultsScreen(final boolean popStack, final int transitionOutId, final int transitionInId) {
        if (networkInfoCollector != null) {
            if (!networkInfoCollector.hasConnectionFromAndroidApi()) {
                showNoNetworkConnectionToast();
                return;
        ...
        else
        {
            ...
            final SimpleTestFragment rmbtTestFragment = new SimpleTestFragment();
...
//                return;
        ...
        if (testFragment != null && testFragment.isResumed()) {
            if (testFragment instanceof SimpleTestFragment) {
                if (((SimpleTestFragment) testFragment).onBackPressed()) {
                    return;
                }
            }
