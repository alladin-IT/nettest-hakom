...
public class RMBTResultPagerFragment extends Fragment implements OnTabChangeListener, OnPageChangeListener
{
    ...
    public void onCreate(final Bundle savedInstanceState)
    {
		...
		final boolean isFromMapView = args.getBoolean(ARG_RESULT_OPENED_FROM_MAP, false);
        
        pagerAdapter = new RMBTResultPagerAdapter((RMBTMainActivity) getActivity(), handler, uuid, isFromMapView);
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState)
    {
        ...
        View v = inflater.inflate(R.layout.result_tabhost_pager_main, container, false);
    ...
    public void onPause()
    {
		...
		final Fragment switchFragment = ((RMBTMainActivity) getActivity()).getSupportFragmentManager().findFragmentById(R.id.results_switch_to_new_test);
		if (switchFragment != null) {
			((RMBTMainActivity) getActivity()).getSupportFragmentManager().beginTransaction().remove(switchFragment).commit();
		}
    }
