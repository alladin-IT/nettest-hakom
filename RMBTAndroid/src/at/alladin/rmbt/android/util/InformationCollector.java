...
import com.specure.nettest.shared.model.request.BasicRequest;
...
//                    Log.i(DEBUG_TAG, "Signals1: " + signals.toString());
    ...
    public SpeedtestResultSubmitRequest getResultValuesNew(long startTimestampNs) {
        ...
        if (geoLocations.size() > 0) {
            final List<com.specure.nettest.shared.model.GeoLocation> geoLocationList = new ArrayList<>();
        ...
        {
            final List<com.specure.nettest.shared.model.CellLocation> cellLocationList = new ArrayList<>();
    ...
    private class GeoLocationItem
    {
        ...
        public com.specure.nettest.shared.model.GeoLocation toNewGeoLocationModel(long startTimeStamp) {
            final com.specure.nettest.shared.model.GeoLocation loc = new com.specure.nettest.shared.model.GeoLocation();
    ...
    public static class CellLocationItem
    {
        ...
        public com.specure.nettest.shared.model.CellLocation toNewCellLocationModel(long startTimeStamp) {
            final com.specure.nettest.shared.model.CellLocation loc = new com.specure.nettest.shared.model.CellLocation();
            loc.setTime(new DateTime(tstamp));
            loc.setRelativeTimeNs(tstampNano-startTimeStamp);
