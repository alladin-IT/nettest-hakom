...
package com.specure.nettest.spring.data.couchdb.repository;
...
import com.specure.nettest.spring.data.couchdb.api.EntityInformation;
import com.specure.nettest.spring.data.couchdb.api.ViewParams;
import com.specure.nettest.spring.data.couchdb.api.ViewResult;
import com.specure.nettest.spring.data.couchdb.api.ViewResultRow;
import com.specure.nettest.spring.data.couchdb.api.exceptions.BulkOperationError;
import com.specure.nettest.spring.data.couchdb.api.exceptions.BulkOperationException;
import com.specure.nettest.spring.data.couchdb.internal.AdapterUtils;
import com.specure.nettest.spring.data.couchdb.lightcouch.LightCouchViewConfigurer;
import com.specure.nettest.spring.data.couchdb.support.GenericEntityInformation;
...
public class LightCouchCouchDbRepository<T> implements CouchDbRepository<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#findAll(org.springframework.data.domain.Sort)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#findAll()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#findAll(java.lang.Iterable)
	 */
	@Override
...
//        	.query(type);
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#save(java.lang.Iterable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#findOneByUuid(java.lang.String)
	 */
	@Override
...
//        executeBulk(deleteDocuments, false);
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#find(com.specure.nettest.spring.data.couchdb.api.ViewParams)
	 */
	@Override
	@SuppressWarnings("rawtypes")
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#find(com.specure.nettest.spring.data.couchdb.api.ViewParams, org.springframework.data.domain.Pageable)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#findByView(com.specure.nettest.spring.data.couchdb.api.ViewParams)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.specure.nettest.spring.data.couchdb.repository.CouchDbRepository#findByView(com.specure.nettest.spring.data.couchdb.api.ViewParams, org.springframework.data.domain.Pageable)
	 */
	@Override
