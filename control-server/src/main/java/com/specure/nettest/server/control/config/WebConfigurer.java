...
import com.specure.nettest.server.control.config.db.CouchDbMessageSource;
import com.specure.nettest.server.control.config.support.AcceptHeaderGetParamOverrideLocaleResolver;
...
public class WebConfigurer extends WebMvcConfigurerAdapter {
	...
	public void addCorsMappings(CorsRegistry registry) {
		registry
			.addMapping("/api/**")
				.allowedOrigins("*")
				.allowedMethods("GET", "POST", "PUT", "PATH", "OPTIONS")
