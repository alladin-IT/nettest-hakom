...
public class PlausibilityService {
	...
	private final Logger logger = LoggerFactory.getLogger(PlausibilityService.class);
	...
	public void checkMeasurement(Measurement measurement) {
		logger.info("Checking measurement (uuid={}) for plausibility.", measurement.getUuid());
