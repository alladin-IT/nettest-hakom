...
import com.specure.nettest.server.control.exception.NotClientsMeasurementException;
import com.specure.nettest.server.control.exception.measurement.MeasurementNotFoundException;
...
import com.specure.nettest.shared.model.NetworkType.NetworkTypeName;
			...
			if (isUpdate && testFinishedNow) {
				...
				if (networkType != null) {
					...
					if (lastMeasurement != null) {
						...
						if (lastNetworkGroupType.equals(NetworkTypeName.WLAN) && !curNetworkGroupType.equals(NetworkTypeName.WLAN) || 
								!lastNetworkGroupType.equals(NetworkTypeName.WLAN) && curNetworkGroupType.equals(NetworkTypeName.WLAN)) {
							measurement.setOpenUuid(UUID.randomUUID().toString());
						}
					}
				}
