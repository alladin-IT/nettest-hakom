...
public class MeasurementSpeedtest {
	...
	public int hashCode() {
		...
		result = prime * result + (int) (numThreadsUl ^ (numThreadsUl >>> 32));
		result = prime * result + (int) (pingMedian ^ (pingMedian >>> 32));
		long temp;
		temp = Double.doubleToLongBits(pingMedianLog);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		result = prime * result + (int) (pingShortest ^ (pingShortest >>> 32));
		temp = Double.doubleToLongBits(pingShortestLog);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(pingVariance);
		result = prime * result + (int) (temp ^ (temp >>> 32));
