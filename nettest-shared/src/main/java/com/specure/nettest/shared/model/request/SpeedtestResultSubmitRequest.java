...
import com.specure.nettest.shared.model.CellLocation;
import com.specure.nettest.shared.model.ExtendedTestStat;
...
public class SpeedtestResultSubmitRequest extends BasicRequestImpl {
	...
	public String toString() {
		return "SpeedtestResultSubmitRequest [clientLanguage=" + clientLanguage + ", clientSoftwareVersion="
				...
				+ ", ipLocal=" + ipLocal + ", ipServer=" + ipServer + ", durationUploadNs=" + durationUploadNs
				+ ", durationDownloadNs=" + durationDownloadNs + ", numThreads=" + numThreads + ", numThreadsUl="
				+ numThreadsUl + ", pingShortest=" + pingShortest + ", portRemote=" + portRemote + ", speedDownload="
				+ speedDownload + ", speedUpload=" + speedUpload + ", token=" + token + ", totalBytesDownload="
				+ totalBytesDownload + ", totalBytesUpload=" + totalBytesUpload + ", interfaceTotalBytesDownload="
				+ interfaceTotalBytesDownload + ", interfaceTotalBytesUpload=" + interfaceTotalBytesUpload
				+ ", interfaceDltestBytesDownload=" + interfaceDltestBytesDownload + ", interfaceDltestBytesUpload="
				+ interfaceDltestBytesUpload + ", interfaceUltestBytesDownload=" + interfaceUltestBytesDownload
				+ ", interfaceUltestBytesUpload=" + interfaceUltestBytesUpload + ", time=" + time
				+ ", relativeTimeDlNs=" + relativeTimeDlNs + ", relativeTimeUlNs=" + relativeTimeUlNs + ", uuid=" + uuid
				+ ", telephonyInfo=" + telephonyInfo + ", wifiInfo=" + wifiInfo + ", cellLocations=" + cellLocations
				+ ", publishPublicData=" + publishPublicData + ", tag=" + tag + "]";
	}
}
