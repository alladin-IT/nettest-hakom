...
import com.specure.nettest.shared.UuidAwareEntity;
...
public class Measurement extends UuidAwareEntity {
	...
	public String toString() {
		return "Measurement [implausible=" + implausible + ", deleted=" + deleted + ", comment=" + comment
				...
				+ mobileNetworkInfo + ", networkInfo=" + networkInfo + ", speedtest=" + speedtest + ", locations="
				+ locations + ", realLocation=" + realLocation + ", signals=" + signals + ", cellLocations="
				+ cellLocations + ", wifiInfo=" + wifiInfo + ", wifiLinkSpeed=" + wifiLinkSpeed + ", signalStrength="
				+ signalStrength + ", lteRsrp=" + lteRsrp + ", lteRsrq=" + lteRsrq + "]";
	}
}