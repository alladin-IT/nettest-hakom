...
import com.specure.nettest.shared.annotation.ExcludeFromOpenTest;
...
public class MeasurementClientInfo {
	...
	public String toString() {
		return "MeasurementClientInfo [uuid=" + uuid + ", softwareVersion=" + softwareVersion + ", name=" + name
				+ ", language=" + language + ", localIp=" + localIp + ", ipLocal=" + ipLocal + ", ipLocalAnonymized="
				+ ipLocalAnonymized + ", ipLocalType=" + ipLocalType + ", time=" + time + ", testCounter=" + testCounter
				+ ", previousTestStatus=" + previousTestStatus + ", softwareRevision=" + softwareRevision + ", version="
				+ version + ", type=" + type + ", timezone=" + timezone + "]";
	}
}