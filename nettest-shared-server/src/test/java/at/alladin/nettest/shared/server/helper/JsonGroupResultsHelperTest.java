...
public class JsonGroupResultsHelperTest {
	...
	public void jsonGroupedSuccessfully_NoDuplicateValuesAndCarriedOverOtherValues(){
		JsonObject resObj = JsonGroupResultsHelper.groupJsonResult(testJson, gson.fromJson(testCorrectGroupStructure, JsonArray.class));//new JsonArray(testCorrectGroupStructure));
	...
	public void jsonGroupingAllEntriesOfJsonObject_DeletesThatJsonObject(){
		JsonObject resObj = JsonGroupResultsHelper.groupJsonResult(testJson, gson.fromJson(testCorrectGroupStructureAllClientInfo, JsonArray.class));
		assertFalse(resObj.has("client_info"));
	}
	
	@Test
	public void jsonGroupedWithUnfoundStructureValues_WorksGracefully(){
		JsonObject resObj = JsonGroupResultsHelper.groupJsonResult(testJson, gson.fromJson(testGroupStructureWithInvalidFields, JsonArray.class));
