...
public class ControlServerConnection
{
    ...
    public void requestQoSTestParametersNew(final String uuid, final boolean encryption) {
    	try {
    		final QosMeasurementRequest request = new QosMeasurementRequest();
    ...
    public SpeedtestResultSubmitResponse sendTestResult(TotalTestResult speedResult, SpeedtestResultSubmitRequest result) {
        try {
            ...
            if (speedResult.pings != null && !speedResult.pings.isEmpty()) {
                final List<com.specure.nettest.shared.model.Ping> pingList = new ArrayList<>();
